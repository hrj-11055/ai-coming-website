...
function buildDailyNewspicImagePrompt({ date, coreItems, content }) {
    ...
    return [
        `日期：${formatNewspicChineseDate(date)}。请在 ChatGPT 网页版中直接生成一张高质量中文 AI 日报图，采用竖版报纸构图。`,
        '版式要求：白底纸媒质感、深蓝报头、粗黑大标题、细线分栏、5 列 x 2 行的 10 条要闻区块。',
        '内容主题必须来自下面【内容主题清单】，用科技视觉元素和信息图氛围体现这些主题，不要引入清单之外的公司、人物、数字或新闻。',
        '请准确呈现 10 条短标题和两句话概括；如果文字过密，优先保证标题、日期和每条新闻的核心信息清晰可读。',
        '标题使用“小元说 AI日报”，必须显示当天日期；不要添加二维码、外部 Logo、水印、网址或无关宣传语。',
        '',
        '【内容主题清单】',
        topicLines,
        '',
        ...
        contentReference,
        '',
        '【视觉风格】中文报纸头版、深蓝与黑白主色、少量红色日期强调、信息密度高但边界清晰，适合微信公众号贴图日报。',
        '',
