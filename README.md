...
| 页面 | 路径 | 说明 |
|------|------|------|
| 首页 | `/index.html` | 每日 AI 新闻、关键词云、播客播放 |
| 提示生成专家 | `/news.html` | 提示词生成、品牌展示、使用引导 |
...
| AI | DeepSeek（播客稿）、MiniMax（TTS）、SiliconFlow/千问（提示生成专家） |
| 音频存储 | 阿里云 OSS（可回退本地） |
| 部署 | Linux 服务器 + PM2 |
